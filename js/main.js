  ...
  switch (toggleType) {
    ...
    case "font":
      if (toggleValue == "fontVerdanaSans")
        $("#page")
          .removeClass("droid")
          .removeClass("roboto")
          .removeClass("verdana-serif")
          .addClass("verdana-sans");
      else if (toggleValue == "fontVerdanaSerif")
        $("#page")
          .removeClass("verdana-sans")
          .removeClass("droid")
          .removeClass("roboto")
          .addClass("verdana-serif");
    ...
    case "edyear":
      if (toggleValue == "edyearFirst") {
        ...
        document.getElementById("column4").className =
          document.getElementById("column3").className;
        document.getElementById("column3").className =
          document.getElementById("column2").className;
        document.getElementById("column2").className =
          document.getElementById("column1").className;
    ...
    case "experience":
      if (toggleValue == "experience1") {
        $("#sectionExperience .title , #sectionExperience .time").css(
          "display",
          "inline-block"
        );
    ...
    case "projects":
      if (toggleValue == "projects1") {
        $("#sectionProjects .title , #sectionProjects .time").css(
          "display",
          "inline-block"
        );
...
function insertList() {
  ...
  ul.innerHTML =
    "<li>Sub-point 1 : Description</li><li>Sub-point 2 : Description</li>";
  insertAfter(node, ul);
}
...
function decreaseIndent() {
  ...
  node.style.paddingLeft =
    parseInt(window.getComputedStyle(node).getPropertyValue("padding-left")) -
    5;
}
